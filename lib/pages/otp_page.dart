...
class _OtpPageState extends State<OtpPage> with SingleTickerProviderStateMixin {
  ...
  // --- LOGIC BASED ON YOUR WORKING REFERENCE ---
  Future<void> _verifyOtp() async {
    ...
    try {
      ...
      if (user != null) {
        // If this is a new user signing up, create their document.
        ...
        // The key fix: always navigate to the root.
        // Another part of your app will handle routing to the correct home page.
        if (mounted) {
